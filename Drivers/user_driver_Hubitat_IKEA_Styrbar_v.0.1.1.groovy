...
*    2023-02-24  bmohseni	   version 0.1.1 updated code from previous mentioned authors
*                              - Fixed some of the code to realize side buttons (2 & 4)
*                              - correctly when pushed, held, or released
...
metadata {
	definition (name: "IKEA Styrbar", namespace: "Hubitat", author: "Ben Mohseni") {
    capability "Actuator"
    capability "Battery"
